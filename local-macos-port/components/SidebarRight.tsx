...
const SidebarRight: React.FC = () => {
  ...
  return (
    <aside className="w-full md:w-80 h-full glass-panel border-l border-white/10 flex flex-col z-20 overflow-y-auto">
      ...
      <div className="flex-1 pb-20">
        ...
        <Panel title="Color Grading">
          <div className="space-y-4">
            <div>
              <span className="text-[10px] uppercase text-gray-400 font-bold mb-2 block">Shadows</span>
              <Slider
                label="Hue"
            ...
            <div className="border-t border-white/5 pt-4">
              <span className="text-[10px] uppercase text-gray-400 font-bold mb-2 block">Highlights</span>
              <Slider
                label="Hue"
